...
title_label = tk.Label(root, text="Contact Management System", bg="#f0f4f8", fg="#2c3e50", font=("Arial", 16, "bold"))
...
btn_add = tk.Button(button_frame, text="Add Contact", command=Add_Contacts, bg="#3498db", fg="white", activebackground="#2980b9", font=("Arial", 10, "bold"))
